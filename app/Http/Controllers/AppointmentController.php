...
class AppointmentController extends Controller
{
    ...
    {
        $query = Sale::with(['customer', 'staff', 'payments', 'items']);
        ...
        $totalServices = $sales->sum('services_total');
        $totalProducts = $sales->sum('products_total');
        $totalTips = $sales->sum('tip_amount');
